...
gulp.task('concat', ['compress'], function() {
  return gulp.src(['./src/compressed/angular.min.js','./src/compressed/angular-route.min.js','./src/compressed/angular-resource.min.js','./src/compressed/angular-bootstrap-ui.min.js','./src/compressed/app.js','./src/compressed/home.js'])
    .pipe(concat('all.js'))
